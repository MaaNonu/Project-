...
<main>
    <h1> Upload a Team Sheet </h1>
        ...
        <main>
        <p> Click "Chosen" to add a new player to the team sheet</p>
         <form method="post" action="processteamnews.php">
       ...
       <form method="post" action="processteamnews.php">
        <label for ="playername" > <b> Player's Name </b> </label>
            <input type="text" placeholder= "Type Here" name="playername">
            <input type="submit" name="chosen" value="chosen">
            </form>
            </textarea>
</main>
<footer>
